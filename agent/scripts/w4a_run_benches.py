...
Output:
    ~/.person-trading/reports/alpha_bench_*.html      — per-run HTML reports
    ~/.person-trading/reports/bench_<zoo>_<uni>.json  — per-run raw results
    ~/.person-trading/reports/bench_summary.json      — aggregate summary
...
REPORTS_DIR = Path.home() / ".person-trading" / "reports"
