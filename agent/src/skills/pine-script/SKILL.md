...
This skill exports a Person-Trading strategy to **all major trading platforms** in one go.
...
```pinescript
// This strategy was generated by Person-Trading
...
```mql5
//+------------------------------------------------------------------+
//| Generated by Person-Trading                                         |
//+------------------------------------------------------------------+
#property copyright "Person-Trading"
...
When generating code, map Person-Trading instrument codes appropriately:

| Person-Trading | TradingView | 通达信/同花顺 | MT5 |
|-------------|-------------|---------------|-----|
...
- [ ] Comment header notes the original Person-Trading run_id and instrument
