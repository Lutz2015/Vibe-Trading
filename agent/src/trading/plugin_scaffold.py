...
_ADAPTER_TEMPLATE = '''"""Read-only local connector generated by Person-Trading.
...
def scaffold_connector(connector_id: str, destination: Path) -> Path:
    ...
    (target / "README.md").write_text(
        ...
        "read-only API docs, "
        "then run `person-trading connector validate .` and `person-trading connector install .`.\n",
        encoding="utf-8",
    )
    return target
