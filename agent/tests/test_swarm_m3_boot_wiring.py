...
The contract this file defends:
  ...
  * Without the env var, ``~/.person-trading/swarm-agent.json`` (the swarm-
    specific operator file) is preferred over ``agent.json``.
  * Without either swarm-specific file, ``~/.person-trading/agent.json``
...
real ``~/.person-trading`` directory of whoever is running the suite.
"""
